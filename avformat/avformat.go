...
// AvAppendPacket reads data and append it to the current content of the Packet.
...
// AvformatGetClass gets the Class for Context.
...
// AvCodecGetTag gets the codec tag for the given codec id id.
...
// AvAddIndexEntry adds an index entry into a sorted list.
...
// AvFilenameNumberTest checks whether filename actually is a numbered sequence generator.
