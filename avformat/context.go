...
// AvReadPlay starts playing a network-based stream (e.g.
...
// AvWriteUncodedFrame writes a uncoded frame to an output media file.
...
// AvInterleavedWriteUncodedFrame writes a uncoded frame to an output media file.
