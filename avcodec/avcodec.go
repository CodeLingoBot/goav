...
// AvcodecLicense returns the libavcodec license.
...
// AvcodecGetClass gets the Class for Context.
func AvcodecGetClass() *Class {
	return (*Class)(C.avcodec_get_class())
}

// AvcodecGetFrameClass gets the Class for Frame.
func AvcodecGetFrameClass() *Class {
	return (*Class)(C.avcodec_get_frame_class())
}

// AvcodecGetSubtitleRectClass gets the Class for AvSubtitleRect.
